...
const QuotePage = () => {
  ...
  return (
    <div className="bg-surface min-h-screen pt-32 pb-24 px-8">
      <div className="max-w-screen-2xl mx-auto grid lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 flex flex-col gap-12">
          ...
          {/* Form Content */}
          <div className="bg-white rounded-[2.5rem] p-12 shadow-xl shadow-blue-900/5 transition-all min-h-[500px] flex flex-col">
            ...
            <div className="mt-12 flex justify-between gap-4 pt-10 border-t border-slate-100">
              {step > 1 ? (
                <button 
                  onClick={prevStep}
                  className="px-10 py-4 rounded-xl font-bold border border-slate-200 hover:bg-slate-50 transition-all flex items-center gap-2"
                >
              ...
              <button 
                ...
                className={`px-12 py-4 rounded-xl font-bold flex items-center gap-3 transition-all ${step === 1 && (!formData.origin || !formData.destination) ? 'bg-slate-200 text-slate-400 cursor-not-allowed' : 'editorial-gradient text-white shadow-lg shadow-primary/20 active:scale-95'}`}
              >
                {step === 3 ? 'Generate Quote' : 'Next: ' + (step === 1 ? 'Volume & Frequency' : 'Contact Details')}
